<template>
  <div ref="wrapper" style="margin-bottom: 1.11rem; background: white">
    ...
    <div>
      ...
      <report :type="1" :id="data.id"></report>
      <similar :type="1" :data="recommendList" @reloadView="reloadDetail"></similar>
    </div>
    <foot-view :isshoucang="data.isshoucang" :type="1" :id="data.id" :phone="data.phone" @reloadView="isShoucangReload"></foot-view>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    created() {
      this.getHouseSalerecommend()
      this.getHouseSaleDetail(this.$route.query.id)
    },
    mounted() {
